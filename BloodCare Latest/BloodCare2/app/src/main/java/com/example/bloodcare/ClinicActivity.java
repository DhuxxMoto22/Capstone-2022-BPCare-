...
import com.example.bloodcare.cfinder.viewmodel.MainViewModel;
import com.example.bloodcare.databinding.ActivityClinicBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.searchLocation.setOnEditorActionListener((v, actionId, event) -> {
            ...
            if (strKeyword.isEmpty()) {
                Toast.makeText(ClinicActivity.this, "Please Input A Place!", Toast.LENGTH_SHORT).show();
            } else {
